...
public class Admin {
    ...
    public static Map<String, Object> postMethodFunctionality(Map<String, String> formFields) {
        ...
        if (formFields.containsKey("approve")) flag = DataMapper.approveProf(formFields.get("approve"));
        if (formFields.containsKey("deny")) flag = DataMapper.deleteReq(formFields.get("deny"));
        ...
        if (formFields.containsKey("searchText")) {
            ...
            Map<Integer, String> users = DataMapper.viewUsers(searchText, filterBy);
        ...
        if (formFields.containsKey("admin"))
            if (DataMapper.authorize(formFields.get("admin"))) {
