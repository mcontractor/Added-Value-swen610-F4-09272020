            ...
            <div class="card" style="width: 35%; border: #78C2AD">
                ...
                <form action="/discussion-groups" method="post">
                    ...
                    <div class="space-between">
                        <input class="form-control col-5" required name="searchText" type="text" placeholder="Search" value="${searchText!""}">
                        <select class="form-control col-2" name="filterBy" id="exampleSelect1" style="margin-right: 2%">
