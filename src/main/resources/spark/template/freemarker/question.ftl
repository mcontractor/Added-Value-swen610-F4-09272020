...
<#--                                    </div>-->
                                    ...
                                    <div class="form-group space-between">
                                        ...
                                        <input required type="text" name="Q1A" class="form-control" id="1a"  <#if question ??>value=${question.responseA!""}</#if> >
                                    </div>
                                    <div class="form-group space-between">
                                        <label class="padding2right" for="1b">B</label>
                                        <input required type="text" name="Q1B" class="form-control" id="1b"  <#if question ??>value=${question.responseB!""}</#if> >
                                    </div>
                                    <div class="form-group space-between">
                                        <label class="padding2right" for="1c">C</label>
                                        <input required type="text" name="Q1c" class="form-control" id="1c"  <#if question ??>value=${question.responseC!""}</#if> >
                                    </div>
                                    <div class="form-group space-between mb3">
                                        <label class="padding2right" for="1d">D</label>
                                        <input required type="text" name="Q1D" class="form-control" id="1d"  <#if question ??>value=${question.responseD!""}</#if> >
                                    </div>
                                    <div class="form-group space-between">
                                        <label class="padding2right" for="ans1">Answer</label>
                                        <input required type="text" name="ans1" class="form-control" id="ans1"  <#if question ??>value=${question.answer!""}</#if> >
                                    </div>
                                    <#if question ??>
